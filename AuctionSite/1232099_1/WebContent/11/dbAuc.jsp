...
郵便番号(ハイフンなし)<input type="text" maxlength="7" style="ime-mode:disabled" onKeyup="this.value=this.value.replace(/[^0-9]+/,'')" name="address"><br>

<input type="hidden" name="command" value="完了">
<input type="image" src="icon/submit.png" style="cursor:pointer">
</form>
